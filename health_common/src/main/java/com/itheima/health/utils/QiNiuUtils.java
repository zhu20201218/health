...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "-9lDgdOa9HsHWhwaFcS-4kwxB7IyHv8Vq1Br79aZ";
    private static final String SECRETKEY = "XMpS-JqdOOga77icU6IXnEZGuQ7F5ng1MnLAVxcc";
    private static final String BUCKET = "bhhealth";
    public static final String DOMAIN= "http://r3qusahl9.hn-bkt.clouddn.com/";

    public static void main(String[] args) {
        uploadFile("C:\\Users\\故是。\\Desktop\\game\\1.jpg","dd2.jpg");
